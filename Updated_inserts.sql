...
INSERT INTO BREWERY (brewery_id, name, date_established, phone_number, website, city, country, state, zipcode, region_id, beer_count, history_description) VALUES
(1, 'Wasatch_Brewery', '1986-01-01', '801-783-1127', 'www.wasatchbeers.com', 'Salt Lake City', 'United States', 'Utah', 84111, 1, 2 ,'This Brewery was founded in 1986 to satisfy the most discerning beer enthusiasts. "Where''s the beer? Where are the breweries?" Those were among the first thoughts Greg Schirf had after moving to Utah from Milwaukee in the early 80s. Incredibly, drinking and brewing were all but forbidden. Greg took matters into his own hands and did what any self respecting midwesterner would do: He started a brewery. Wasatch was the very first brewery in Utah, and one of the first craft brewers in all of the U.S., brewing award winning brews since 1986.');

INSERT INTO BREWERY (brewery_id, name, date_established, phone_number, website, city, country, state, zipcode, region_id, beer_count, history_description) VALUES
(2, 'Epic_Brewery', '2008-01-01', '801-906-0123', 'www.epicbrewing.com', 'Salt Lake City', 'United States', 'Utah', 84111, 1, 1 ,'David Cole and Peter Erickson are the founders and co-owners of Epic Brewing Company. Cole and Erickson, originally from California, started an international aquaculture company in Utah in 1992. In 28, Utah law changed allowing these two entrepreneurs to pursue their longtime dream of opening a strong beer microbrewery in Utah, like those they frequented in the Golden State.');

INSERT INTO BREWERY (brewery_id, name, date_established, phone_number, website, city, country, state, zipcode, region_id, beer_count, history_description) VALUES
(3, 'Left_Hand_Brewing', '1980-02-23', '303-772-0258', 'www.lefthandbrewing.com', 'Longmont', 'United States', 'Colorado', 80501, 1, 3 ,'Living here in our great state requires great balance theres just simply too much to do! Soak in over 3 days of sunshine a year. Catch a show at Red Rocks. Climb to the top of 14,255ft Longs Peak. Catch an Avs or Rockies game. Drop into some fresh powder at A-Basin. Tee up on the first hole at Haystack Mountain.');

INSERT INTO BREWERY (brewery_id, name, date_established, phone_number, website, city, country, state, zipcode, region_id, beer_count, history_description) VALUES
(4, 'Bridger_Brewing', '2013-03-02', '406-587-2124', 'www.bridgerbrewing.com', 'Bozeman', 'United States', 'Montana', 59715, 1, 1 ,"Choosing the Bridger Brewing name for our dream was easy. From the mountain man Jim Bridger himself; to the beautiful mountains that surround our community, the name is legendary; inspiring happenings that are outside the realm of possibility for most, but not for us. We climb the iciest peaks, swim the swiftest rivers, con the most elusive trout, still hunt, gather or grow many of our meals, laugh easy, cry some and perhaps most of all, relish and appreciate this miraculous spot on the globe we call home.");

INSERT INTO BREWERY (brewery_id, name, date_established, phone_number, website, city, country, state, zipcode, region_id, beer_count, history_description) VALUES
(5, 'Big_Beaver_Brewing', '2010-01-01', '970-818-6064', 'www.bigbeaverbrew.com', 'Loveland','United States', 'Colorado', 80537, 1, 3, "Since 2010, the Big Beaver Brewing Company has been creating delicious craft beer in the shadows of the Rocky Mountain National Park. This awe-inspiring view demands equally awesome beer, and the Big Beaver Brewery provides just that with 16 beers on tap to choose from. Enjoy your favorite beer in the cozy confines of our Taproom or to-go in refillable growlers. Stop by today and see for yourself why everybody is saying…");

INSERT INTO BREWERY (brewery_id, name, date_established, phone_number, website, city, country, state, zipcode, region_id, beer_count, history_description) VALUES
(6, 'Spencer_Brewery', '1957-01-01', '508-885-5756', 'www.spencerbrewery.com', 'Spencer','United States', 'Massachusetts', 01562, 1, 2, "Trappist communities observe the counsel of the Rule of St. Benedict, a 6th century guide for monastic life, that stresses the importance of ora et labora or pray and work. Monks are encouraged to be self-supportive and offer charitable assistance to others by producing and selling goods to the public.");

INSERT INTO BREWERY (brewery_id, name, date_established, phone_number, website, city, country, state, zipcode, region_id, beer_count, history_description) VALUES
(7, 'Lagunitas_Brewing_Company', '2013-03-02', '406-587-2124', 'www.lagunitas.com', 'Petaluma','United States', 'California', 94954,  9, 0, "From points distant and beyond we all converged on Petaluma in 1993 and '94 with an unenunciated desire to be more than we were before. The core of Lagunitas came from Chicago, St Louis, Memphis, Walker Creek, and the highlands of Quincy");
